...
PHG4CylinderGeom_Spacalv3::load_demo_sector_tower_map4()
{
  cout << "PHG4CylinderGeom_Spacalv3::load_demo_sector_tower_map4 - "
      << "FermiLab test beam 2014. Need to move to calibration database" << endl;
  ...
  cout << "PHG4CylinderGeom_Spacalv3::load_demo_sector_tower_map4 - "
<<"Adjust wide end width by ratio of "<< wide_width_x_construction/wide_width_x<<" and narrow end by ratio of "
