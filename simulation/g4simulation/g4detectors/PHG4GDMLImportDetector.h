#ifndef PHG4GDMLImportDetector_h
#define PHG4GDMLImportDetector_h
...
class PHG4GDMLImportDetector: public PHG4Detector
{

  public:

  //! constructor
  PHG4GDMLImportDetector( PHCompositeNode *Node, const std::string &dnam="BLOCK", const int lyr = 0 );

  //! destructor
  virtual ~PHG4GDMLImportDetector( void )
  {}
  ...
  void SetDisplayProperty( G4AssemblyVolume* lv);
