#ifndef Fun4AllHepMCSingleTrackInputManager_H__
#define Fun4AllHepMCSingleTrackInputManager_H__
...
class Fun4AllHepMCSingleTrackInputManager : public Fun4AllInputManager
{
 public:
  Fun4AllHepMCSingleTrackInputManager(const std::string &name = "DUMMY", const std::string &nodename = "DST", const std::string &topnodename = "TOP");
  virtual ~Fun4AllHepMCSingleTrackInputManager();
 ...
 protected:
  ...
  bool IsStateFinal(const HepMC::GenParticle *p)
  {
...
#endif /* __Fun4AllHepMCSingleTrackInputManager_H__ */
